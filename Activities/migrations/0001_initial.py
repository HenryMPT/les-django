# Generated by Django 2.1.7 on 2019-06-25 11:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artefactid', models.ForeignKey(blank=True, db_column='ArtefactID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Activities.Artefact', verbose_name='Artefacto')),
                ('resourceid', models.ForeignKey(blank=True, db_column='ResourceID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Activities.Resource', verbose_name='Recurso')),
                ('userid', models.ForeignKey(db_column='UserID', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Sentence',
